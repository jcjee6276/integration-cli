        ...
        <section className="flex flex-col gap-2">
          <div className="flex items-center justify-between">
            ...
            <textarea
              ...
              onChange={(e) => setTitle(e.target.value)}
              placeholder="예: 로그인 페이지 UI 구현 및 API 연동"
              className="w-full resize-none rounded-xl border border-gray-900/[0.08] bg-gray-900/[0.03] px-3 py-2.5 text-sm text-gray-900/80 placeholder-gray-900/20 transition-colors outline-none focus:border-orange-500/50 focus:bg-gray-900/[0.05] dark:border-white/[0.08] dark:bg-white/[0.03] dark:text-white/80 dark:placeholder-white/20 dark:focus:bg-white/[0.05]"
            />
          </section>
              ...
              <ul className="flex flex-col gap-1.5">
                {form.requirements.map((req, idx) => (
                  <li key={req.id} className="flex items-center gap-2">
                    <span className="w-5 shrink-0 text-center text-xs text-gray-900/20 dark:text-white/20">
                      {idx + 1}
                    </span>
                    <input
                      type="text"
                      ...
                      placeholder="요구사항 입력"
                      className="flex-1 rounded-lg border border-gray-900/[0.07] bg-gray-900/[0.03] px-3 py-1.5 text-xs text-gray-900/70 placeholder-gray-900/20 transition-colors outline-none focus:border-gray-900/[0.15] focus:bg-gray-900/[0.05] dark:border-white/[0.07] dark:bg-white/[0.03] dark:text-white/70 dark:placeholder-white/20 dark:focus:border-white/[0.15] dark:focus:bg-white/[0.05]"
                    />
                    <button
                      type="button"
          ...
          <section className="flex flex-col gap-2">
            ...
            {form.agents.length === 0 ? (
              <div className="flex items-center justify-center rounded-xl border border-dashed border-gray-900/[0.07] py-5 dark:border-white/[0.07]">
                <p className="text-xs text-gray-900/20 dark:text-white/20">
                  서브 에이전트를 추가하세요
                </p>
              </div>
            ) : (
