      ...
      <div className="flex flex-col gap-6">
        ...
        <section className="flex flex-col gap-2">
          ...
          <textarea
            ...
            className="w-full resize-none rounded-xl border border-gray-700 bg-gray-950 px-3 py-2.5 text-sm text-gray-100 placeholder-gray-600 outline-none transition-colors focus:border-gray-500"
          />
        </section>

        {/* ── 워크 디렉토리 ─────────────────────────────────────────── */}
        <section className="flex flex-col gap-2">
          <label className="text-xs font-medium text-gray-400">워크 디렉토리 <span className="text-gray-600">(선택)</span></label>
          <input
            type="text"
        ...
        <div className="flex justify-end gap-2 border-t border-gray-800 pt-4">
          <button
            ...
            onClick={handleClose}
            disabled={submitting}
            className="rounded-xl px-4 py-2 text-sm text-gray-400 transition-colors hover:bg-gray-800 hover:text-gray-200 disabled:opacity-40"
          >
            취소
          </button>
          <button
