  ...
  return (
    <div className="flex w-full justify-start gap-3">
      ...
      <div className="max-w-[75%] min-w-0 rounded-2xl rounded-tl-sm border border-yellow-700/50 bg-yellow-950/40 px-4 py-3 text-sm">
        ...
        {warning && (
          <p className="mb-3 text-xs text-yellow-500/80">⚠ {warning}</p>
        )}
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={onDeny}
            className="rounded-lg bg-gray-700 px-3 py-1.5 text-xs font-medium text-gray-200 transition-colors hover:bg-gray-600"
          >
            거부
          </button>
        </div>
